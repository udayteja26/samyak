...
<head>
    ...
    <title>Poster Presentation Report Form</title>
...
<body>
 ...
 <form action="tech.php" method="post">
    <div ng-app="myApp" ng-controller="controller">
        <div class="container">
		   ...
		   <a href="logout.php">Logout</a>
            ...
            <h3 align="center">Poster Presentation Certificate Form</a></h3>
            <br/>
            <div class="row">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr ng-repeat="data in searched = (file | filter:search | orderBy : base :reverse) | beginning_data:(current_grid-1)*data_limit | limitTo:data_limit">
								...
								<td>{{data.poster}}</td>
								<?php echo "<td><a target='_blank' href=\"postercertview.php?sno={{data.sno}}\">Edit</a>  </td> "?>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script src="postermyapp.js"></script>
	</form>
</body>
</html>