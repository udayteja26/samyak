...
<head>	
<meta charset="UTF-8">
  <title>Paper Presentation Report Form</title>
...
<body>
	...
	<form name="form1" method="post" action="papercerttech.php">
		<table border="0">
			
		
		
		 <fieldset>
          <legend><span class="number">1</span>paper Presentation Certificate Report Form</legend>
		...
		<label for="name">Name:</label>
          ...
          <label for="events">PaperPresentation Events Status:</label>
