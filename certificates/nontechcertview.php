...
<body>
	...
	<form name="form1" method="post" action="nontechcerttech.php">
		<table border="0">
			
		
		
		 <fieldset>
          <legend><span class="number">1</span>Non Tech Certificate Report Form</legend>
		...
		<label for="name">Name:</label>
          ...
          <label for="events">Non Tech Events Status:</label>
