...
<head>
    ...
    <title>Literary Cretificate Report Form</title>
...
<body>
 ...
 <form action="tech.php" method="post">
    <div ng-app="myApp" ng-controller="controller">
        <div class="container">
		   ...
		   <a href="logout.php">Logout</a>
            ...
            <h1 align="center">Literary Certificate Report Form</a></h1>
            <br/>
            <div class="row">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr ng-repeat="data in searched = (file | filter:search | orderBy : base :reverse) | beginning_data:(current_grid-1)*data_limit | limitTo:data_limit">
								...
								<td>{{data.literary}}</td>
								<?php echo "<td><a target='_blank' href=\"literarycertview.php?sno={{data.sno}}\">Edit</a>  </td> "?>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script src="literarymyapp.js"></script>
	</form>
</body>
</html>